    ...
    <>
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 xl:col-span-8 flex flex-col overflow-hidden rounded-[18px] border border-border bg-white p-5 shadow-[0_8px_24px_rgba(5,5,5,0.05)]">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-1 rounded-xl border border-border bg-bg-page px-2 py-1.5">
                  <button
                    onClick={handleChartPreviousYear}
                    className="rounded-md p-1 text-text-secondary transition-colors hover:bg-white hover:text-text-primary"
                    title="Previous Year"
                  >
                    <ChevronLeft size={14} />
                  </button>
                  <select
                    ...
                    className="rounded-md border border-border bg-white px-3 py-1.5 text-[13px] font-medium text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                  >
                    {generateYearOptions().map((year) => (
                      <option key={year} value={year}>
                        {year}
                  ...
                  >
                    <ChevronLeft
                      size={14}
                      className={cn(!chartSelectedMonth && "opacity-30")}
                    />
                  </button>
                  <select
                  ...
                  <button
                    ...
                    className="ml-1 rounded-md bg-primary px-3.5 py-1.5 text-[13px] font-semibold text-white transition-colors hover:bg-primary/90"
                  >
                    Apply
                  </button>
                </div>

                <div className="flex items-center rounded-xl border border-border bg-bg-page p-1">
                ...
                <button
                  ...
                  className="rounded-xl border border-border bg-white px-4 py-2 text-[13px] font-medium text-text-primary transition-colors hover:bg-bg-page"
                >
                  Export CSV
                </button>
              </div>
              ...
              {isClient && !isChartLoading && chartDataState.length > 0 ? (
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart
                    ...
                    barCategoryGap={chartDataState.length <= 3 ? "70%" : "30%"}
                    barGap={4}
                  >
                    <CartesianGrid
                      strokeDasharray="3 3"
                    ...
                    <Bar
                      ...
                      radius={[4, 4, 0, 0]}
                      barSize={aggregationType === "quarterly" ? 42 : 24}
                    />
                    <Bar
                      name="Expenses"
                      dataKey="expenses"
                ...
                <div className="flex h-full w-full items-center justify-center rounded-[14px] border border-dashed border-border bg-bg-page/30 p-8">
                  <div className="flex items-center gap-3">
                    <TrendingUp
          ...
          <div className="col-span-12 xl:col-span-4 card-base card-p flex flex-col">
